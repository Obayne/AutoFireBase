...
class AutoFireApp:
    ...
    def create_widgets(self):
        ...
        title = tk.Label(
            self.root,
            text="🔥 AutoFire AI - Construction Intelligence",
            font=("Arial", 16, "bold"),
            fg="orange",
            bg="#2b2b2b",
        )
        ...
        results_frame = tk.LabelFrame(
            self.root, text="Analysis Results", fg="white", bg="#2b2b2b", font=("Arial", 12, "bold")
        )
        results_frame.pack(pady=20, padx=20, fill="both", expand=True)

        self.results_text = tk.Text(
            results_frame, bg="#1e1e1e", fg="white", font=("Consolas", 10), wrap=tk.WORD
        )
