...
class AssistantDock(QtWidgets.QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.input.setPlaceholderText("Ask: e.g., 'Place detectors along corridor at 30 ft spacing'")
        self.btn_suggest = QtWidgets.QPushButton("Suggest Layout")
        row = QtWidgets.QHBoxLayout()
        row.addWidget(self.input); row.addWidget(self.btn_suggest)
        lay.addLayout(row)
    ...
    def _on_suggest(self):
        ...
        self.log.append("Assistant (stub): I would create a grid/line array based on your spacing and corridor length.")
