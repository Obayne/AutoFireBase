...
def create_professional_font(size: int = AutoFireTypography.BODY_MEDIUM, 
                           weight: int = AutoFireTypography.WEIGHT_NORMAL):
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    # Demo the design system  
    primary_colors = [AutoFireColor.PRIMARY, AutoFireColor.SECONDARY, 
                     AutoFireColor.ACCENT]
