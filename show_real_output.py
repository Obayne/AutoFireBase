...
def show_real_working_output():
    ...
    try:
        ...
        if pdf_path.exists():
            ...
            print(
                f"   Result attributes: {[attr for attr in dir(result) if not attr.startswith('_')][:10]}"
            )
            ...
            print("✅ RFI ENGINE WORKS - NO CRASH!")
    ...
    print("1. Real PDF processing without crashes")
    print("2. Real RFI engine that doesn't crash on 'floor_plans' attribute")
    print("3. Real working Python files you can run")
    print("4. Real analysis objects being passed (not strings)")
