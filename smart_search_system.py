...
class SearchIndex:
    ...
    def search(
        self, query: str, filters: List[SearchFilter] | None = None, max_results: int = 100
    ) -> List[SearchResult]:
    ...
    def _highlight_matches(
        self, item: dict, query_words: List[str], match_fields: List[str]
    ) -> str:
        ...
        for field in match_fields[:3]:  # Show top 3 matching fields
            ...
            for word in query_words:
                ...
                highlighted_value = pattern.sub(
                    f'<b style="color: {AutoFireColor.PRIMARY};">{word}</b>', highlighted_value
                )
...
class SmartSearchWidget(QWidget):
    ...
    def _create_search_section(self) -> QWidget:
        ...
        section.setStyleSheet(
            f"background: {AutoFireColor.SURFACE}; border-radius: 8px; padding: 10px;"
        )
        ...
        self.building_filter.addItems(
            ["All Buildings", "Office", "Hospital", "School", "Warehouse", "Hotel", "Retail"]
        )
        ...
        self.type_filter.addItems(
            ["All Types", "Detection", "Notification", "Manual", "Control", "Power"]
        )
    ...
    def _create_results_area(self) -> QWidget:
        ...
        self.results_title.setStyleSheet(
            f"font-weight: bold; color: {AutoFireColor.TEXT}; padding: 10px;"
        )
    ...
    def load_data(self):
        ...
        try:
            ...
            mock_codes = [
                {
                    "name": "NFPA 72 - Chapter 17",
                    "type": "code",
                    "category": "Detection",
                    "description": "Initiating Device Circuits",
                },
                {
                    "name": "NFPA 72 - Chapter 18",
                    "type": "code",
                    "category": "Notification",
                    "description": "Notification Appliance Circuits",
                },
                {
                    "name": "NFPA 72 - Chapter 23",
                    "type": "code",
                    "category": "Installation",
                    "description": "Protected Premises Fire Alarm Systems",
                },
                {
                    "name": "UL 268",
                    "type": "standard",
                    "category": "Detection",
                    "description": "Smoke Detectors for Fire Alarm Systems",
                },
                {
                    "name": "UL 521",
                    "type": "standard",
                    "category": "Detection",
                    "description": "Heat Detectors for Fire Alarm Systems",
                },
                {
                    "name": "ADA Guidelines",
                    "type": "standard",
                    "category": "Notification",
                    "description": "Visual Notification Requirements",
                },
            ]
            ...
            self.status_label.setText(
                f"Ready to search {len(all_items):,} devices, codes, and standards"
            )
            ...
            demo_data = [
                {
                    "name": "System Sensor 2W-B",
                    "type": "detector",
                    "manufacturer": "System Sensor",
                    "model": "2W-B",
                },
                {
                    "name": "Edwards 270-SPO",
                    "type": "manual",
                    "manufacturer": "Edwards",
                    "model": "270-SPO",
                },
                {
                    "name": "Wheelock AS-24MCW",
                    "type": "notification",
                    "manufacturer": "Wheelock",
                    "model": "AS-24MCW",
                },
    ...
    def _create_filter_widget(self, search_filter: SearchFilter) -> QWidget:
        ...
        widget.setStyleSheet(
            f"border: 1px solid {AutoFireColor.BORDER}; border-radius: 4px; margin: 2px;"
        )
        ...
        for value in values_to_show:
            ...
            checkbox.stateChanged.connect(
                lambda state, f=search_filter, v=value: self._toggle_filter_value(f, v, state)
            )
        ...
        if len(search_filter.values) > 10:
            ...
            more_label.setStyleSheet(
                f"color: {AutoFireColor.TEXT_SECONDARY}; font-style: italic; padding-left: 20px;"
            )
