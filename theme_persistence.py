...
class ThemePersistence:
    ...
    def backup_themes(self, backup_path: str) -> bool:
        ...
        try:
            ...
            shutil.copytree(self.themes_dir, backup_dir / "themes", dirs_exist_ok=True)
    ...
    def restore_themes(self, backup_path: str) -> bool:
        ...
        try:
            ...
            current_backup = (
                self.themes_dir.parent / f"themes_backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
            )
...
class ThemeApplicationService:
    ...
    def get_circuit_style(self, circuit_type: str) -> str:
        ...
        circuit_classes = {"SLC": "circuit-slc", "NAC": "circuit-nac", "POWER": "circuit-power"}
