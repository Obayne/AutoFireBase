...
try:
    from PySide6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                                   ...
                                   QToolBar, QDockWidget, QTextEdit, QProgressBar,
...
class SystemStatus:
    ...
    def __init__(self):
        self.systems = {
            ...
            'reporting': {'name': 'Reporting & Documentation', 'status': 'unknown', 'last_check': None},
...
class AutoFireDashboard(QWidget):
    ...
    def _setup_ui(self):
        ...
        status_label = QLabel(f"System Status: {overall_status.title()} ({loaded_count}/{total_count} systems active)")
...
<i>The complete solution for fire alarm engineering professionals.</i>
    ...
    def _create_system_status_widget(self, system_info: Dict) -> QWidget:
        ...
        if system_info['last_check']:
            ...
            time_label.setStyleSheet(f"color: {AutoFireColor.TEXT_MUTED}; font-size: {AutoFireFont.SIZE_SMALL}px;")
...
def main():
    ...
    try:
        ...
        print(f"📊 System Status: {sum(SYSTEMS_LOADED.values())}/{len(SYSTEMS_LOADED)} systems loaded")
        print("")
