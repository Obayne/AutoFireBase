# apply_hotfix_array_cad_063.py
# Fix Array tool (preview + clicks), add Esc-cancel, Delete selected, Export PNG.
# Overwrites: app/tools/array.py, app/main.py (backs up with .bak-<timestamp>)
...
class MainWindow(QMainWindow):
    ...
    def export_png(self):
        ...
        # render items bounding rect to image
