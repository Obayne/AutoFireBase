# apply_autofire_full_061.py
# Rebuilds a WORKING AutoFire baseline (CAD + Devices + Coverage + Array + Dimension)
# Safe to run multiple times; backs up overwritten files with .bak-<timestamp>
...
def main():
    ...
    try:
        ...
        w = MinimalWindow(); w.show(); app.exec()
    except Exception:
        import traceback
