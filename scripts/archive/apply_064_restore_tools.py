# apply_064_restore_tools.py
# Restores Tools menu (Draw + Dimension), reconnects canvas handlers,
# and adds a persistent Grid opacity slider in the status bar.
...
APP_VERSION = "0.6.4-restore-tools"
...
class CanvasView(QGraphicsView):
    ...
    def mouseMoveEvent(self, e: QtGui.QMouseEvent):
        ...
        # forward to draw/dimension if active
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Toolbar stays minimal (per your preference)
        ...
        # Status bar: Grid opacity slider (10..100%)
        sb = self.statusBar()
    ...
    def _populate_filters(self):
        ...
        self.cmb_mfr = self.findChild(QComboBox) if hasattr(self,'cmb_mfr') else None
        # (Rebuild palette fresh)
        # left panel
        ...
        # assemble central if not yet
        if not isinstance(self.centralWidget(), QWidget):
            ...
            # on first init central is not set; we handle in __init__ instead.
            pass
...
def create_window():
    win = MainWindow()
    # Build left panel + list on first init
